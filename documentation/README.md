# sectiony Documentation

Welcome to the documentation for **sectiony**.

## Guides

*   [**User Guide**](user guide.md): A general overview of how to use the library.
*   [**Creating Sections**](creating sections.md): Learn how to define custom geometries programmatically.
*   [**Standard Library**](library.md): Using the built-in library of standard shapes (I-beams, CHS, RHS, etc.).
