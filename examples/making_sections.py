...
def save_plot(section: Section, filename: str) -> None:
    ...
    ax.set_title(f"{section.name}\nA={section.A:.1f} mm^2, Ix={section.Ix:.1e} mm^4", 
                 fontsize=10)
...
print(f"   Area: {chs_section.A:.2f} mm^2")
print(f"   Iy: {chs_section.Iy:.2f} mm^4")
...
print(f"   Area: {rhs_section.A:.2f} mm^2")
print(f"   Ix: {rhs_section.Ix:.2f} mm^4")
print(f"   Iy: {rhs_section.Iy:.2f} mm^4")
...
print(f"   Area: {i_section.A:.2f} mm^2")
print(f"   Strong axis Ix: {i_section.Ix:.2f} mm^4")
...
print(f"   Area: {u_section.A:.2f} mm^2")
...
print(f"   Area: {rect_section.A:.2f} mm^2")
print(f"   Expected: 100 × 50 = 5000 mm^2")
...
print(f"   Area: {triangle_section.A:.2f} mm^2")
...
print(f"   Area: {d_section.A:.2f} mm^2")
print(f"   Expected: pi * 50^2 / 2 approx 3927 mm^2")
...
print(f"   Area: {rounded_rect_section.A:.2f} mm^2")
...
print(f"   Area: {hollow_rect_section.A:.2f} mm^2")
print(f"   Expected: 100×60 - 60×40 = 3600 mm^2")
...
print(f"   Area: {ring_section.A:.2f} mm^2")
print(f"   Expected: pi(50^2 - 30^2) approx 5027 mm^2")
...
print(f"   Area: {i_beam_with_opening_section.A:.2f} mm^2")
...
print(f"   Area: {loaded_section.A:.2f} mm^2")
print(f"   Original area: {rounded_rect_section.A:.2f} mm^2")
...
print(f"   Recreated section area: {recreated_section.A:.2f} mm^2")
